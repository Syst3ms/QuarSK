...
public class SExprPotionItemEffects extends SimpleExpression<PotionEffect> {
    ...
    static {
        Registration.newExpression("Potion effects of an item (any potion/tipped arrow)", SExprPotionItemEffects.class, PotionEffect.class, ExpressionType.COMBINED, "[(all|every|each)] [potion] effect[s] (on|of) %itemstack%", "[(all|each) of] %itemstack%['s] [potion] effect[s]");
    }
