...
public class ExprRandomBanner extends SimpleExpression<ItemStack> {
    ...
    static {
        Registration.newExpression("A fully randomized banner or shield", ExprRandomBanner.class, ItemStack.class, ExpressionType.SIMPLE, "[a] [new] random (0¦banner|1¦shield)");
    }
