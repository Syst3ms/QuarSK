...
public class ExprCustomBannerLayer extends SimpleExpression<Pattern> {
    ...
    static {
        Registration.newExpression("A custom banner layer", ExprCustomBannerLayer.class, Pattern.class, ExpressionType.COMBINED, "[new] [banner] (layer|pattern) (with|using|of|from) pattern [type] %bannerpattern% colo[u]r[ed] %color%");
    }
